...
#df_97to104 = df_1to104[(df_1to104.Week_Num .> 305),:]; # Project 1 for 7 weeks
...
#trans_cost = 1.35/20; # Project C reduce transportation costs
fixed_cost_DC = 25000000;               # Fixed cost per DC ($)
v =  dc[:,:Variable_Cost] * 13.5 / 5;   # cost per pallet capacity
#fixed_cost_DC = 25000000*0.9;  v =  dc[:,:Variable_Cost] * 13.5 / 5* 0.9; # Project B reduce DC cost by 10%
